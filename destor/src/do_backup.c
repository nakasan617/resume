...
void do_backup(char *path) {
	...
	start_dedup_phase();
	printf("end of dedup_phase\n");
	start_rewrite_phase();
	printf("end of dedup_phase\n");
	start_filter_phase();
	printf("end of filter_phase\n");
	...
	fprintf(stderr, "I'm still looping yo, jcr.status = %d\n", jcr.status);
	...
	/* DO NOT UNCOMMENT THE LINES BELOW!!! ORIGINAL FILE COMMENTS THIS OUT TOO. */
