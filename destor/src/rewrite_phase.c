...
static void* no_rewrite(void* arg) {
    ...
    printf("done with rewrite thread\n");

    return NULL;
}

void start_rewrite_phase() {
    printf("came to rewrite phase\n");
	...
	printf("this is the option we are choosing correct?\n");
    ...
    printf("done with rewrite phase\n");
